...
class test_add_new_contact(unittest.TestCase):
    ...
    def test_add_new_contact(self):
        ...
        self.create_new_contact(wd, New_contact(firstname="Louis", middlename="van", lastname="Gaal", nickname="King Louis", title="Coach", company="Manchester United Football Club",
